...
public class FacebookVideoCapitalWordSpotterDao	extends	AbstractDao	implements	IFacebookFeedCapitalWordSpotterDao
{
	private	PropertiesConfiguration	_config;
	
	public	FacebookVideoCapitalWordSpotterDao()
	{
		super();
		try 
		{
			_config	=	new	PropertiesConfiguration("config/SqlScripts/FeedsWithCapitalizedWords/Facebook/video.properties");
		} 
	...
	private	List<ICapitalWordsSearchableFeed>	GetVideos( List<Object[]> objects )
	{
		...
		while(iterator.hasNext())
		{
			...
			ICapitalWordsSearchableContent	content	=	new	CapitalizedFacebookVideo();
			((CapitalizedFacebookVideo)content).setCaption((String)object[_config.getInt( "caption.index" )]);
