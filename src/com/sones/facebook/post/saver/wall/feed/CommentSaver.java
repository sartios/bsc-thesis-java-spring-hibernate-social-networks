...
public class CommentSaver	implements	ICommentSaver
{
	...
	private	IFacebookPostSaver postSaver;
	...
	/**
	 * @param postSaver the postSaver to set
	 */
	public void setPostSaver(IFacebookPostSaver postSaver) {
		this.postSaver = postSaver;
	}

	/**
	 * @return the postSaver
	 */
	public IFacebookPostSaver getPostSaver() {
		return postSaver;
	}
