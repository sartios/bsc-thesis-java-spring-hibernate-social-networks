...
public class FacebookFriendTest {
	...
	@Test
	public void getFeeds_GetFeedListForKeywordSearch_Test(){
		FacebookFriend friend = new FacebookFriend("Sartios", "100000866964787");
		String token="access_token=106911326013695|ea1c5d947c3788fa382b0abf-747618741|MeTjo25aPlPeqlEucqb4ZoZe50Y";
		FacebookFeedList feeds_ = friend.getFeeds("keywordSearch", token);
		Feed feed=feeds_.getNewerFeed();
		assertFalse(feed.getComments_().isEmpty());
	}
	
	@Test
	public void getFeeds_GetSimpleFeedList_Test(){
		FacebookFriend friend = new FacebookFriend("Sartios", "100000866964787");
		String token="access_token=106911326013695|ea1c5d947c3788fa382b0abf-747618741|MeTjo25aPlPeqlEucqb4ZoZe50Y";
		FacebookFeedList feeds_ = friend.getFeeds("noSearch", token);
		Feed feed=feeds_.getNewerFeed();
