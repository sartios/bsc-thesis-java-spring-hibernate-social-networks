...
public class StatusMessageViewer extends JFrame {
	 ...
	 */
	public void setStatusMessageContent(final String message){
	 ...
	 */
	public void setStatusMessageCreator(final String creator){
	 ...
	 */
	public void setStatusMessageDate(final String date){
