...
public class VideoSearchDataManagerTester 
{

	private	IVideoSearchDataManager	dataManager;
	private	ApplicationContext	context;
	
	public	VideoSearchDataManagerTester()
	{
	...
	public	void	setUp()
	{
		dataManager	=	(VideoSearchDataManager)context.getBean("videoDataManager");
	}
	...
	@Test
	public	void	testGetVideoForSearchWhenUserHasSearchAgainForKeywords()
	{
		...
		IVideoDao	postDao	=	( HibernateVideoDao )context.getBean("videoDao");
		for( int postIndex = 1; postIndex < loopIterations; postIndex++ )
		{
			Video	video	=	new	Video();
			video.setId( String.valueOf( postIndex ) );
			video.setUser( user );
			postDao.Save( video );
			posts.add( video );
		}
