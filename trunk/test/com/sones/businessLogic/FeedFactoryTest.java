...
/*	*//**
	...
	@Test
	public void setNumberOfComments_Test(){
		
		FacebookToken token = new FacebookToken();
		TokenDao dao = new TokenDao();
		token = (FacebookToken) dao.findAll().get(0);
		FacebookRestHandler handler = new FacebookRestHandler();
		com.sones.businessLogic.Feed feed = handler.getFeed("100000866964787_152492174812686", token.getToken());
		
		assertEquals(1, feed.getNumberOfComments_());
	}
