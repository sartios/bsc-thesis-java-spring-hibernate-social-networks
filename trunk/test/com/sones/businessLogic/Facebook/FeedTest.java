...
public class FeedTest {
	...
	public void constructorWithoutArguments_CreatesFeed_Test(){
		...
		try{
			...
			CommentList comments=feed1.getComments_();
			comments.isEmpty();
		}
	...
	public void getComments_ThereAreDifferentComments_Test(){
		...
		comments.addComment(new Comment("1", "a", "2"));
		comments.addComment(new Comment("2", "a", "2"));
		comments.addComment(new Comment("3", "a", "2"));
		feed_.setComments_(comments);
		assertEquals(comments.getSize(), feed_.getComments_().getSize());
	}
	...
	public void getComments_TheCommentsAreSame_Test(){
		...
		comments.addComment(new Comment("1", "a", "2"));
		feed_.setComments_(comments);
		assertEquals(1, feed_.getComments_().getSize());
	}
	
	@Test
	public void setComments_NullComments_Test(){
		feed_.setComments_(null);
		assertEquals(0, feed_.getComments_().getSize());
	}
	...
	@Test
	public void keywordExistsInComments_keywordExists_Test(){
		CommentList comments = new CommentList();
		Comment comment = new Comment("1","keyword","2");
		comments.addComment(comment);
		feed_.setComments_(comments);
		String keyword = "keyword";
		assertTrue(feed_.keywordExistsInComments(keyword));
	}
	
	@Test
	public void keywordExistsInComments_keywordDoesNotExist_Test(){
		CommentList comments = new CommentList();
		Comment comment = new Comment("1","keyword","2");
		comments.addComment(comment);
		feed_.setComments_(comments);
		String keyword = "ARIS";
		assertFalse(feed_.keywordExistsInComments(keyword));
	}
	
	@Test
	public void find_keywordExistsInComments_Test(){
		CommentList comments = new CommentList();
		Comment comment = new Comment("1","keyword","2");
		comments.addComment(comment);
		feed_.setComments_(comments);
		String keyword = "keyword";
		assertTrue(feed_.find(keyword));
	}
	
	@Test
	public void find_keywordDoesNotExistInComments_Test(){
		CommentList comments = new CommentList();
		Comment comment = new Comment("1","keyword","2");
		comments.addComment(comment);
		feed_.setComments_(comments);
